<script>
	...
	import LiteLLM from './Settings/LiteLLM.svelte';
	...
	const allSettings = [
		...
		},
		{
			id: 'litellm',
			title: 'LiteLLM',
			route: '/admin/settings/litellm',
			keywords: ['litellm', 'budget', 'spending', 'api key', 'proxy', 'widget']
		}
	];
